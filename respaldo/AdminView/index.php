...
try {
  ...
  $sql = "SELECT neg.*,cat.nombrecategoria as categoria FROM negocio as neg 
          inner join categorias as cat on cat.id_categoria=neg.id_categoria order by id_negocio desc";    
