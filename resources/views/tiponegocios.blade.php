                        ...
                        <div class="grid grid-cols-2 gap-8">
                                ...
                                <div class="grid grid-cols-1 gap-6 md:grid-cols-4">
                                        <a href="{{ route('tiponegocio',$ptiponegocio['slug']) }}">
                                                <img src="@if (true) {{$ptiponegocio['imagen']}} @else ../images/tiponegocios/{{$ptiponegocio['imagen']}} @endif" class="object-cover w-full h-40 col-span-1 bg-center" alt="Kutty" loading="lazy" />
