...
<div class=" rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
  <div class="-mx-3 md:flex mb-6 justify-between">
    <div class="w-full px-3 ">
      ...
      <input name="imagen" 
      value="{{old('imagen',$imagen->imagen)}}" 
      class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3" type="file" placeholder="imagen">
