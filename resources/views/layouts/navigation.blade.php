        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex ">
                    ...
                    <x-nav-link :href="route('categorias')" :active="request()->routeIs('categorias')" class="dark:text-white">
                        {{ __('Categorías') }}
                    </x-nav-link>

                    <x-nav-link :href="route('tiponegocios')" :active="request()->routeIs('tiponegocios')" class="dark:text-white">
                        {{ __('Tipos de Negocios') }}
                    </x-nav-link>

                    <x-nav-link :href="route('clientes')" :active="request()->routeIs('clientes')" class="dark:text-white">
                        {{ __('Clientes') }}
                    </x-nav-link>

                    <x-nav-link :href="route('negocios')" :active="request()->routeIs('negocios')" class="dark:text-white">
                        {{ __('Negocios') }}
                    </x-nav-link>

                    <x-nav-link :href="route('imagenes')" :active="request()->routeIs('imagenes')" class="dark:text-white">
                        {{ __('Imagenes') }}
                    </x-nav-link>
