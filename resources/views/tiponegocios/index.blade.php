                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        ...
                                        <div class="flex items-center">
                                                <div class="flex-shrink-0 w-10 h-10 hidden sm:table-cell">
                                                    <img class="w-full h-full rounded-full" src="@if(isset($tiponegocio->imagen)) images/tiponegocios/{{$tiponegocio->imagen}} @else images/user_placeholder.png @endif" alt="" />
                                                </div>
                                                <div class="ml-3">
